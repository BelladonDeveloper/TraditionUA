...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Awake()
        {
            ...
            // Get a reference to the camera rendering the script taking into consideration the script component type.
        ...
        void LateUpdate()
        {
            ...
            {
                // Reset all selections given we are hovering outside the script container bounds.
                m_selectedLink = -1;
                m_lastCharIndex = -1;
                m_lastWordIndex = -1;
                m_lastLineIndex = -1;
